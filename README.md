...
| 版本 | 平台 | 下载链接 | 大小 |
|------|------|----------|------|
| v6.3.0 | Windows | [ImageClassifier_v6.3.0.exe](https://gitlab.desauto.cn/api/v4/projects/820/packages/generic/image_classifier/6.3.0/ImageClassifier_v6.3.0.exe) | ~86MB |
| Latest | Windows | [ImageClassifier_latest.exe](https://gitlab.desauto.cn/api/v4/projects/820/packages/generic/image_classifier/latest/ImageClassifier_v6.3.0.exe) | ~86MB |

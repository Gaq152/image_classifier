...
| 版本 | 平台 | 下载链接 | 大小 |
|------|------|----------|------|
| v6.2.0 | Windows | [ImageClassifier_v6.2.0.exe](https://gitlab.desauto.cn/api/v4/projects/820/packages/generic/image_classifier/6.2.0/ImageClassifier_v6.2.0.exe) | ~86MB |
| Latest | Windows | [ImageClassifier_latest.exe](https://gitlab.desauto.cn/api/v4/projects/820/packages/generic/image_classifier/latest/ImageClassifier_v6.2.0.exe) | ~86MB |
...
### 🎯 最新版本 - v6.2.0 (2025-10-09)

**主要更新**：
- ✨ 新增类别忽略功能：支持隐藏不需要的类别目录，目录不会被删除

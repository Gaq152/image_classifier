...
| 版本 | 平台 | 下载链接 | 大小 |
|------|------|----------|------|
| v5.4.4 | Windows | [ImageClassifier_v5.4.4.exe](https://gitlab.desauto.cn/api/v4/projects/820/packages/generic/image_classifier/5.4.4/ImageClassifier_v5.4.4.exe) | ~86MB |
| Latest | Windows | [ImageClassifier_latest.exe](https://gitlab.desauto.cn/api/v4/projects/820/packages/generic/image_classifier/latest/ImageClassifier_v5.4.4.exe) | ~86MB |

...
| 版本 | 平台 | 下载链接 | 大小 |
|------|------|----------|------|
| v6.1.1 | Windows | [ImageClassifier_v6.1.1.exe](https://gitlab.desauto.cn/api/v4/projects/820/packages/generic/image_classifier/6.1.1/ImageClassifier_v6.1.1.exe) | ~86MB |
| Latest | Windows | [ImageClassifier_latest.exe](https://gitlab.desauto.cn/api/v4/projects/820/packages/generic/image_classifier/latest/ImageClassifier_v6.1.1.exe) | ~86MB |
